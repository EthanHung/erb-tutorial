...
/*
const array = [1,2,3,{x: 10, y: 11},5,6,7];
...
callbackTest(result => {
    setTimeout(() => {
        console.log('after 800ms will show up');
    }, 800);
});
*/
...
const asyncFunction = async () => {
    getApiCall('https://fakestoreapi.com/products')
    .then(function(data) {
        console.log('data', data)
        addElements(data);
    })

    let products = await getApiCall('https://fakestoreapi.com/products');
}
*/
